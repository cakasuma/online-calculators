...
const translations = {
  ...
  "tax.group.family": { en: "You & family", ms: "Anda & keluarga", id: "Anda & keluarga" },
  "tax.group.medical": { en: "Medical & insurance", ms: "Perubatan & insurans", id: "Medis & asuransi" },
  "tax.group.savings": { en: "Education & savings", ms: "Pendidikan & simpanan", id: "Pendidikan & tabungan" },
  "tax.group.lifestyle": { en: "Lifestyle & other", ms: "Gaya hidup & lain-lain", id: "Gaya hidup & lainnya" },
  "tax.cap": { en: "Cap {cap}", ms: "Had {cap}", id: "Batas {cap}" },
  "tax.relief.personal": { en: "Personal relief", ms: "Pelepasan diri", id: "Keringanan pribadi" },
  "tax.relief.disabledSelf": { en: "Disabled individual", ms: "Individu kurang upaya", id: "Individu disabilitas" },
  "tax.relief.spouse": { en: "Spouse", ms: "Pasangan", id: "Pasangan" },
  "tax.relief.children": { en: "Children", ms: "Anak", id: "Anak" },
  "tax.relief.medical": { en: "Medical (serious illness)", ms: "Perubatan (penyakit serius)", id: "Medis (penyakit serius)" },
  "tax.relief.parentsMedical": { en: "Medical for parents", ms: "Perubatan ibu bapa", id: "Medis orang tua" },
  "tax.relief.supportingEquipment": { en: "Supporting equipment", ms: "Peralatan sokongan", id: "Peralatan penunjang" },
  "tax.relief.lifeInsurance": { en: "Life insurance / takaful", ms: "Insurans hayat / takaful", id: "Asuransi jiwa / takaful" },
  "tax.relief.educationMedicalInsurance": { en: "Education & medical insurance", ms: "Insurans pendidikan & perubatan", id: "Asuransi pendidikan & medis" },
  "tax.relief.epf": { en: "EPF / approved scheme", ms: "KWSP / skim diluluskan", id: "EPF / skema disetujui" },
  "tax.relief.socsoEis": { en: "SOCSO & EIS", ms: "PERKESO & SIP", id: "SOCSO & EIS" },
  "tax.relief.prs": { en: "PRS / deferred annuity", ms: "PRS / anuiti tertunda", id: "PRS / anuitas tertunda" },
  "tax.relief.sspn": { en: "SSPN net deposit", ms: "Deposit bersih SSPN", id: "Setoran bersih SSPN" },
  "tax.relief.educationFees": { en: "Education fees (self)", ms: "Yuran pendidikan (sendiri)", id: "Biaya pendidikan (sendiri)" },
  "tax.relief.lifestyle": { en: "Lifestyle", ms: "Gaya hidup", id: "Gaya hidup" },
  "tax.relief.sports": { en: "Sports equipment & facilities", ms: "Peralatan & kemudahan sukan", id: "Peralatan & fasilitas olahraga" },
  "tax.relief.childcare": { en: "Childcare & kindergarten", ms: "Taska & tadika", id: "Penitipan anak & TK" },
  "tax.relief.breastfeeding": { en: "Breastfeeding equipment", ms: "Peralatan penyusuan", id: "Peralatan menyusui" },
  "tax.relief.evCharging": { en: "EV charging facility", ms: "Kemudahan pengecas EV", id: "Fasilitas pengisian EV" },
  "tax.relief.housingLoanInterest": { en: "First-home loan interest", ms: "Faedah pinjaman rumah pertama", id: "Bunga pinjaman rumah pertama" },
  "tax.inputs.disabledSelf": { en: "I am a registered person with disabilities", ms: "Saya individu kurang upaya berdaftar", id: "Saya penyandang disabilitas terdaftar" },
  "tax.inputs.disabledSpouse": { en: "My spouse is disabled", ms: "Pasangan saya kurang upaya", id: "Pasangan saya disabilitas" },
  "tax.inputs.childrenUnder18": { en: "Children under 18", ms: "Anak bawah 18", id: "Anak di bawah 18" },
  "tax.inputs.childrenUnder18.hint": { en: "RM2,000 each.", ms: "RM2,000 setiap seorang.", id: "RM2.000 masing-masing." },
  "tax.inputs.childrenTertiary": { en: "Children in tertiary education", ms: "Anak di IPT", id: "Anak di pendidikan tinggi" },
  "tax.inputs.childrenTertiary.hint": { en: "RM8,000 each — diploma level and above.", ms: "RM8,000 setiap seorang — peringkat diploma ke atas.", id: "RM8.000 masing-masing — diploma ke atas." },
  "tax.inputs.disabledChildren": { en: "Disabled children", ms: "Anak kurang upaya", id: "Anak disabilitas" },
  "tax.inputs.disabledChildren.hint": { en: "RM6,000 each.", ms: "RM6,000 setiap seorang.", id: "RM6.000 masing-masing." },
  "tax.inputs.disabledChildrenTertiary": { en: "Disabled children in higher education", ms: "Anak kurang upaya di IPT", id: "Anak disabilitas di pendidikan tinggi" },
  "tax.inputs.disabledChildrenTertiary.hint": { en: "RM14,000 each.", ms: "RM14,000 setiap seorang.", id: "RM14.000 masing-masing." },
  "tax.inputs.epf": { en: "EPF / approved scheme (RM)", ms: "KWSP / skim diluluskan (RM)", id: "EPF / skema disetujui (RM)" },
  "tax.inputs.epf.hint": { en: "Capped at RM4,000 — separate from life insurance.", ms: "Had RM4,000 — berasingan daripada insurans hayat.", id: "Batas RM4.000 — terpisah dari asuransi jiwa." },
  "tax.inputs.lifeInsurance": { en: "Life insurance / takaful (RM)", ms: "Insurans hayat / takaful (RM)", id: "Asuransi jiwa / takaful (RM)" },
  "tax.inputs.lifeInsurance.hint": { en: "Capped at RM3,000 — a separate limit from EPF.", ms: "Had RM3,000 — had berasingan daripada KWSP.", id: "Batas RM3.000 — batas terpisah dari EPF." },
  "tax.inputs.educationMedicalInsurance": { en: "Education & medical insurance (RM)", ms: "Insurans pendidikan & perubatan (RM)", id: "Asuransi pendidikan & medis (RM)" },
  "tax.inputs.parentsMedical": { en: "Medical for parents (RM)", ms: "Perubatan ibu bapa (RM)", id: "Medis orang tua (RM)" },
  "tax.inputs.supportingEquipment": { en: "Supporting equipment (RM)", ms: "Peralatan sokongan (RM)", id: "Peralatan penunjang (RM)" },
  "tax.inputs.supportingEquipment.hint": { en: "For a disabled self, spouse, child or parent.", ms: "Untuk diri, pasangan, anak atau ibu bapa kurang upaya.", id: "Untuk diri, pasangan, anak atau orang tua disabilitas." },
  "tax.inputs.socsoEis": { en: "SOCSO & EIS (RM)", ms: "PERKESO & SIP (RM)", id: "SOCSO & EIS (RM)" },
  "tax.inputs.prs": { en: "PRS / deferred annuity (RM)", ms: "PRS / anuiti tertunda (RM)", id: "PRS / anuitas tertunda (RM)" },
  "tax.inputs.sspn": { en: "SSPN net deposit (RM)", ms: "Deposit bersih SSPN (RM)", id: "Setoran bersih SSPN (RM)" },
  "tax.inputs.educationFees": { en: "Education fees, self (RM)", ms: "Yuran pendidikan sendiri (RM)", id: "Biaya pendidikan sendiri (RM)" },
  "tax.inputs.sports": { en: "Sports equipment & facilities (RM)", ms: "Peralatan & kemudahan sukan (RM)", id: "Peralatan & fasilitas olahraga (RM)" },
  "tax.inputs.sports.hint": { en: "A separate RM1,000 on top of lifestyle relief.", ms: "RM1,000 berasingan selain pelepasan gaya hidup.", id: "RM1.000 terpisah di luar keringanan gaya hidup." },
  "tax.inputs.childcare": { en: "Childcare & kindergarten (RM)", ms: "Taska & tadika (RM)", id: "Penitipan anak & TK (RM)" },
  "tax.inputs.breastfeeding": { en: "Breastfeeding equipment (RM)", ms: "Peralatan penyusuan (RM)", id: "Peralatan menyusui (RM)" },
  "tax.inputs.breastfeeding.hint": { en: "Claimable once every two years.", ms: "Boleh dituntut sekali setiap dua tahun.", id: "Dapat diklaim sekali tiap dua tahun." },
  "tax.inputs.evCharging": { en: "EV charging facility (RM)", ms: "Kemudahan pengecas EV (RM)", id: "Fasilitas pengisian EV (RM)" },
  "tax.inputs.housingLoanInterest": { en: "First-home loan interest (RM)", ms: "Faedah pinjaman rumah pertama (RM)", id: "Bunga pinjaman rumah pertama (RM)" },
  "tax.inputs.housingLoanBand": { en: "Property price band", ms: "Julat harga hartanah", id: "Rentang harga properti" },
  "tax.band.upTo500k": { en: "Up to RM500,000", ms: "Sehingga RM500,000", id: "Hingga RM500.000" },
  "tax.band.above500k": { en: "RM500,001 - RM750,000", ms: "RM500,001 - RM750,000", id: "RM500.001 - RM750.000" },
  "tax.inputs.zakat": { en: "Zakat paid (RM)", ms: "Zakat dibayar (RM)", id: "Zakat dibayar (RM)" },
  "tax.inputs.zakat.hint": { en: "A rebate, not a relief — every RM1 of zakat cancels RM1 of tax.", ms: "Rebat, bukan pelepasan — setiap RM1 zakat menolak RM1 cukai.", id: "Rebat, bukan keringanan — setiap RM1 zakat menghapus RM1 pajak." },
  "tax.zakatLink": { en: "Work out your zakat", ms: "Kira zakat anda", id: "Hitung zakat Anda" },
  "tax.individualRebate": { en: "Individual rebate", ms: "Rebat individu", id: "Rebat individu" },
  "tax.zakatRebate": { en: "Zakat rebate", ms: "Rebat zakat", id: "Rebat zakat" },
  "tax.zakatRebate.hint": { en: "Capped at the tax still standing — zakat is never refunded.", ms: "Had setakat cukai yang tinggal — zakat tidak dikembalikan.", id: "Dibatasi pajak yang tersisa — zakat tidak dikembalikan." },
  "tax.reliefBreakdown": { en: "Reliefs claimed", ms: "Pelepasan dituntut", id: "Keringanan diklaim" },
  "tax.reliefBreakdown.hint": { en: "Each relief has its own independent cap.", ms: "Setiap pelepasan mempunyai had tersendiri.", id: "Setiap keringanan punya batas sendiri." },
  ...
  "carloan.badge": { en: "2026 HP rules", ms: "Peraturan SB 2026", id: "Aturan SB 2026" },
  ...
  "carloan.inputs.rate": { en: "Interest rate (p.a.)", ms: "Kadar faedah (setahun)", id: "Suku bunga (per tahun)" },
  "carloan.inputs.rate.hint": { en: "New agreements are typically 4.5%–6.5% on a reducing balance.", ms: "Perjanjian baharu biasanya 4.5%–6.5% atas baki berkurangan.", id: "Perjanjian baru umumnya 4,5%–6,5% atas saldo menurun." },
  "carloan.inputs.tenure": { en: "Loan tenure", ms: "Tempoh pinjaman", id: "Tenor pinjaman" },
  "carloan.inputs.regime": { en: "Which agreement is this?", ms: "Perjanjian yang mana?", id: "Perjanjian yang mana?" },
  "carloan.regime.reducing": { en: "New loan (from 1 June 2026)", ms: "Pinjaman baharu (dari 1 Jun 2026)", id: "Pinjaman baru (dari 1 Juni 2026)" },
  "carloan.regime.flat": { en: "Existing loan (before 1 June 2026)", ms: "Pinjaman sedia ada (sebelum 1 Jun 2026)", id: "Pinjaman lama (sebelum 1 Juni 2026)" },
  "carloan.regime.hint": {
    en: "The Hire-Purchase (Amendment) Act commenced 1 June 2026. New agreements price on a reducing balance; agreements signed before then keep their original flat rate.",
    ms: "Akta Sewa Beli (Pindaan) berkuat kuasa 1 Jun 2026. Perjanjian baharu dikira atas baki berkurangan; perjanjian sebelum itu kekal pada kadar rata asal.",
    id: "UU Sewa Beli (Amandemen) berlaku 1 Juni 2026. Perjanjian baru dihitung atas saldo menurun; perjanjian sebelumnya tetap pada tarif flat aslinya.",
  },
  "carloan.rateFlat": { en: "Flat interest rate (p.a.)", ms: "Kadar faedah rata (setahun)", id: "Suku bunga flat (per tahun)" },
  "carloan.rateFlat.hint": { en: "Pre-2026 agreements were typically 2.5%-3.5% flat.", ms: "Perjanjian sebelum 2026 biasanya 2.5%-3.5% rata.", id: "Perjanjian sebelum 2026 umumnya 2,5%-3,5% flat." },
  "carloan.flatWarning": {
    en: "A flat rate charges interest on the full amount borrowed for every year of the tenure, even as you pay it down. That is why the effective cost is roughly double the headline rate.",
    ms: "Kadar rata mengenakan faedah atas jumlah penuh dipinjam bagi setiap tahun tempoh, walaupun anda membayarnya. Itulah sebabnya kos berkesan hampir dua kali kadar utama.",
    id: "Tarif flat membebankan bunga atas seluruh jumlah pinjaman untuk setiap tahun tenor, meski Anda mencicilnya. Karena itu biaya efektifnya sekitar dua kali tarif utama.",
  },
  "carloan.settle.title": { en: "Early settlement", ms: "Penyelesaian awal", id: "Pelunasan dipercepat" },
  "carloan.settle.enable": { en: "Model settling this loan early", ms: "Model penyelesaian awal pinjaman ini", id: "Modelkan pelunasan dipercepat" },
  "carloan.settle.after": { en: "Settle after (months)", ms: "Selesaikan selepas (bulan)", id: "Lunasi setelah (bulan)" },
  "carloan.settle.after.hint": { en: "How many instalments you will have paid.", ms: "Berapa ansuran yang telah anda bayar.", id: "Berapa cicilan yang sudah Anda bayar." },
  "carloan.settle.amount": { en: "Amount to settle", ms: "Jumlah penyelesaian", id: "Jumlah pelunasan" },
  "carloan.settle.amount.hint": { en: "Cash needed to close the agreement.", ms: "Tunai untuk menutup perjanjian.", id: "Uang untuk menutup perjanjian." },
  "carloan.settle.rebate": { en: "Rule of 78 rebate", ms: "Rebat Rule of 78", id: "Rebat Rule of 78" },
  "carloan.settle.rebate.hint": { en: "Statutory sum-of-digits rebate on the term charges.", ms: "Rebat jumlah digit berkanun atas caj tempoh.", id: "Rebat jumlah digit statutori atas biaya tenor." },
  "carloan.settle.interestSaved": { en: "Interest saved", ms: "Faedah dijimatkan", id: "Bunga dihemat" },
  "carloan.settle.paid": { en: "Instalments already paid", ms: "Ansuran telah dibayar", id: "Cicilan sudah dibayar" },
  "carloan.settle.reducing": { en: "On a reducing balance this would be", ms: "Atas baki berkurangan ia adalah", id: "Atas saldo menurun ini menjadi" },
  "carloan.settle.goodwill": { en: "Goodwill discount worth asking for", ms: "Diskaun ihsan yang wajar dipohon", id: "Diskon niat baik yang layak diminta" },
  "carloan.settle.goodwill.hint": {
    en: "The Rule of 78 leaves you owing this much more than a reducing balance would. Banks have voluntarily agreed to offer discounts closing this gap on early settlement.",
    ms: "Rule of 78 menyebabkan anda terhutang sebanyak ini lebih daripada baki berkurangan. Bank telah bersetuju secara sukarela menawarkan diskaun menutup jurang ini.",
    id: "Rule of 78 membuat Anda berutang sebanyak ini lebih dari saldo menurun. Bank telah sepakat sukarela menawarkan diskon menutup selisih ini.",
  },
  "carloan.schedule.title": { en: "Yearly repayment schedule", ms: "Jadual bayaran balik tahunan", id: "Jadwal pembayaran tahunan" },
  "carloan.schedule.hint": { en: "Required disclosure on agreements from 1 June 2026.", ms: "Pendedahan wajib bagi perjanjian dari 1 Jun 2026.", id: "Pengungkapan wajib untuk perjanjian dari 1 Juni 2026." },
  "carloan.schedule.show": { en: "Show schedule", ms: "Tunjuk jadual", id: "Tampilkan jadwal" },
  "carloan.schedule.hide": { en: "Hide schedule", ms: "Sembunyi jadual", id: "Sembunyikan jadwal" },
  "carloan.schedule.year": { en: "Year", ms: "Tahun", id: "Tahun" },
  "carloan.schedule.principal": { en: "Principal", ms: "Pokok", id: "Pokok" },
  "carloan.schedule.interest": { en: "Interest", ms: "Faedah", id: "Bunga" },
  "carloan.schedule.balance": { en: "Balance", ms: "Baki", id: "Saldo" },
  "carloan.disclaimer": {
