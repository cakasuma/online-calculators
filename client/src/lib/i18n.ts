...
const translations = {
  ...
  "home.zakat.badge": { en: "Zakat", id: "Zakat" },
  "home.hero.badge": { en: "Welcome to HelloKalku", id: "Selamat datang di HelloKalku" },
  "home.hero.subtitle": { en: "Fast, practical calculators and guides for daily finance, advanced math, and Islamic planning. Built for clarity, bilingual usage (English + Indonesian), and mobile-first speed.", id: "Kalkulator dan panduan yang cepat dan praktis untuk keuangan harian, matematika lanjutan, dan perencanaan Islam. Dibuat agar jelas, mendukung dua bahasa (Inggris + Indonesia), dan cepat di perangkat mobile." },
  "home.hero.ctaSalary": { en: "Start with Salary Calculator", id: "Mulai dari Kalkulator Gaji" },
  "home.hero.ctaFaraid": { en: "Open Faraid Calculator", id: "Buka Kalkulator Faraid" },
  "home.featured.title": { en: "Featured tools", id: "Alat unggulan" },
  "home.featured.openTool": { en: "Open tool", id: "Buka alat" },
  "home.why.title": { en: "Why HelloKalku?", id: "Kenapa HelloKalku?" },
  "home.why.body": { en: "HelloKalku is designed for users in Southeast Asia who need trustworthy calculators with clear explanations, localized numbers, and practical references. Whether you are checking net salary, computing zakat, planning faraid distribution, or solving formulas, HelloKalku keeps the interface clean and consistent.", id: "HelloKalku dirancang untuk pengguna di Asia Tenggara yang membutuhkan kalkulator tepercaya dengan penjelasan yang jelas, format angka lokal, dan referensi praktis. Baik Anda menghitung gaji bersih, zakat, pembagian faraid, maupun rumus matematika, HelloKalku menjaga antarmuka tetap rapi dan konsisten." },
  "home.category.Finance.name": { en: "Finance", id: "Keuangan" },
  "home.category.Finance.desc": { en: "Income, tax, and wealth planning tools", id: "Alat untuk perencanaan penghasilan, pajak, dan kekayaan" },
  "home.category.Math.name": { en: "Math", id: "Matematika" },
  "home.category.Math.desc": { en: "Daily and advanced calculation helpers", id: "Bantuan perhitungan harian dan lanjutan" },
  "home.category.Islamic.name": { en: "Islamic", id: "Islam" },
  "home.category.Islamic.desc": { en: "Shariah-aware planning and guidance", id: "Panduan dan perencanaan selaras syariah" },
  "home.category.Documents.name": { en: "Documents", id: "Dokumen" },
  "home.category.Documents.desc": { en: "Guides and generators for legal paperwork", id: "Panduan dan generator untuk dokumen legal" },
  "tools.salary-calculator.name": { en: "Salary Calculator (Malaysia)", id: "Kalkulator Gaji (Malaysia)" },
  "tools.salary-calculator.desc": { en: "Estimate monthly take-home pay with EPF, SOCSO, EIS, and income tax deductions.", id: "Perkirakan gaji bersih bulanan dengan potongan EPF, SOCSO, EIS, dan pajak penghasilan." },
  "tools.salary-calculator.badge": { en: "Popular", id: "Populer" },
  "tools.faraid-calculator.name": { en: "Faraid Calculator", id: "Kalkulator Faraid" },
  "tools.faraid-calculator.desc": { en: "Islamic inheritance share calculator with detailed heir distribution.", id: "Kalkulator pembagian waris Islam dengan rincian ahli waris yang detail." },
  ...
  "faraid.disclaimer.text": {
    ...
    id: "Kalkulator ini mencakup skenario Faraid utama berdasarkan fikih Islam yang muktabar. Selalu konsultasikan dengan ulama atau perencana warisan bersertifikat untuk pembagian resmi.",
  },
  ...
  "wasiat.step2.label": { en: "Step 2", id: "Langkah 2" },
  "wasiat.step3.label": { en: "Step 3", id: "Langkah 3" },
  "wasiat.step1.title": { en: "Eligibility & Introduction", id: "Kelayakan & Pengantar" },
  "wasiat.step2.title": { en: "Bequest Planner", id: "Perencana Wasiat" },
  "wasiat.step3.title": { en: "Summary & Checklist", id: "Ringkasan & Daftar Periksa" },
  "wasiat.intro.what": { en: "What is a Wasiat?", id: "Apa itu Wasiat?" },
  "wasiat.intro.text": { en: "A Wasiat (Arabic: وصية) is an Islamic will — a document where a Muslim declares how up to one-third of their estate should be distributed to non-Faraid beneficiaries, charitable causes, or specific purposes after death. The remaining two-thirds are distributed to legal heirs according to Faraid (Islamic inheritance law).", id: "Wasiat (Arab: وصية) adalah surat wasiat Islam — dokumen di mana seorang Muslim menyatakan bagaimana hingga sepertiga hartanya harus dibagikan kepada penerima non-Faraid, tujuan amal, atau keperluan tertentu setelah meninggal. Dua pertiga sisanya dibagikan kepada ahli waris sesuai Faraid (hukum waris Islam)." },
  "wasiat.eligibility.title": { en: "Eligibility Checklist", id: "Daftar Periksa Kelayakan" },
  "wasiat.eligibility.muslim": { en: "Muslim (Shahada confirmed)", id: "Muslim (Syahadat terkonfirmasi)" },
  "wasiat.eligibility.sane": { en: "Of sound mind (berakal)", id: "Berakal sehat" },
  "wasiat.eligibility.adult": { en: "Adult — 18 years or older", id: "Dewasa — 18 tahun atau lebih" },
  "wasiat.rules.title": { en: "Key Rules", id: "Aturan Utama" },
  "wasiat.rules.onethird": { en: "Maximum 1/3 of estate to non-Faraid heirs or charities", id: "Maksimal 1/3 harta kepada penerima non-Faraid atau badan amal" },
  "wasiat.rules.nolegalheir": { en: "Cannot bequeath to legal Faraid heirs (they receive via Faraid)", id: "Tidak boleh berwasiat kepada ahli waris Faraid (mereka menerima melalui Faraid)" },
  "wasiat.rules.charitable": { en: "Charitable bequests (sadaqah, waqf) are strongly encouraged", id: "Wasiat amal (sedekah, wakaf) sangat dianjurkan" },
  "wasiat.next": { en: "Continue", id: "Lanjutkan" },
  "wasiat.back": { en: "Back", id: "Kembali" },
  "wasiat.form.testator.title": { en: "Testator Details", id: "Detail Pembuat Wasiat" },
  "wasiat.form.fullname": { en: "Full Name", id: "Nama Lengkap" },
  ...
  "wasiat.form.bequests.add": { en: "Add Bequest", id: "Tambah Wasiat" },
  "wasiat.form.bequests.remove": { en: "Remove", id: "Hapus" },
  "wasiat.form.bequests.recipient": { en: "Recipient Name", id: "Nama Penerima" },
  "wasiat.form.bequests.relationship": { en: "Relationship", id: "Hubungan" },
  "wasiat.form.bequests.type": { en: "Type", id: "Jenis" },
  "wasiat.form.bequests.amount": { en: "Amount", id: "Jumlah" },
  "wasiat.form.bequests.type.cash": { en: "Cash", id: "Tunai" },
  "wasiat.form.bequests.type.asset": { en: "Asset", id: "Aset" },
  "wasiat.form.bequests.type.percentage": { en: "Percentage (%)", id: "Persentase (%)" },
  "wasiat.form.bequests.warning": { en: "Total bequests exceed 1/3 of estate. Reduce to comply with Islamic law.", id: "Total wasiat melebihi 1/3 harta. Kurangi agar sesuai hukum Islam." },
  "wasiat.form.bequests.empty": { en: "No bequests added yet. Click 'Add Bequest' to start.", id: "Belum ada wasiat. Klik 'Tambah Wasiat' untuk memulai." },
  "wasiat.form.specialWishes": { en: "Special Wishes / Instructions", id: "Wasiat Khusus / Instruksi" },
  "wasiat.form.specialWishes.placeholder": { en: "e.g. Donate 10% to mosque building fund, care instructions for dependants…", id: "mis. Donasikan 10% untuk dana pembangunan masjid, instruksi perawatan tanggungan…" },
  "wasiat.summary.title": { en: "Your Wasiat Summary", id: "Ringkasan Wasiat Anda" },
  "wasiat.summary.testator": { en: "Testator", id: "Pembuat Wasiat" },
  "wasiat.summary.date": { en: "Date", id: "Tanggal" },
  "wasiat.summary.estate": { en: "Estimated Estate", id: "Perkiraan Harta" },
  "wasiat.summary.bequests": { en: "Bequests", id: "Wasiat" },
  "wasiat.summary.faraid": { en: "Remainder distributed via Faraid to legal heirs", id: "Sisa dibagikan melalui Faraid kepada ahli waris" },
  "wasiat.summary.specialWishes": { en: "Special Wishes", id: "Wasiat Khusus" },
  "wasiat.summary.none": { en: "None", id: "Tidak ada" },
  ...
  "wasiat.planCTA": { en: "Plan your Wasiat →", id: "Rencanakan Wasiat →" },
  "wasiat.validation.name": { en: "Full name is required", id: "Nama lengkap wajib diisi" },
  ...
  "zakat.disclaimer.text": { en: "This calculator provides an estimate based on mainstream Islamic jurisprudence. Consult a qualified Islamic scholar or zakat institution for official assessment.", id: "Kalkulator ini memberikan estimasi berdasarkan fikih Islam yang muktabar. Konsultasikan dengan ulama atau lembaga zakat resmi untuk penilaian resmi." },
  "zakat.currency": { en: "Currency", id: "Mata Uang" },
  "zakat.silverPrice.label": { en: "Silver Price / gram (for Nisab)", id: "Harga Perak / gram (untuk Nisab)" },
  "zakat.silverPrice.help": { en: "Current market silver price per gram. Used to calculate the Nisab threshold (595g silver).", id: "Harga perak pasar saat ini per gram. Digunakan untuk menghitung batas Nisab (595g perak)." },
  "zakat.hawl.label": { en: "Hawl completed (held ≥ 1 lunar year)", id: "Hawl terpenuhi (dimiliki ≥ 1 tahun hijriyah)" },
  "zakat.hawl.help": { en: "Hawl is the condition that wealth must have been held for one complete lunar year before Zakat is due. Uncheck if you haven't held these assets for a full year.", id: "Hawl adalah syarat bahwa kekayaan harus dimiliki selama satu tahun hijriyah penuh sebelum Zakat wajib. Kosongkan jika Anda belum memegang aset ini selama setahun penuh." },
  "zakat.category.cashSavings": { en: "Cash & Savings", id: "Tunai & Tabungan" },
  "zakat.category.goldSilver": { en: "Gold & Silver", id: "Emas & Perak" },
  "zakat.category.investments": { en: "Investments", id: "Investasi" },
  "zakat.category.business": { en: "Business Assets", id: "Aset Bisnis" },
  "zakat.category.rental": { en: "Rental Income", id: "Pendapatan Sewa" },
  "zakat.cash.onHand": { en: "Cash on Hand", id: "Uang Tunai" },
  "zakat.cash.onHand.help": { en: "Physical cash you currently hold at home or in wallet", id: "Uang tunai yang Anda pegang saat ini di rumah atau dompet" },
  "zakat.cash.bankSavings": { en: "Bank Savings", id: "Tabungan Bank" },
  "zakat.cash.bankSavings.help": { en: "Total balance across all savings and current accounts", id: "Total saldo di semua rekening tabungan dan giro" },
  "zakat.cash.fixedDeposits": { en: "Fixed / Time Deposits", id: "Deposito Berjangka" },
  "zakat.cash.fixedDeposits.help": { en: "Principal plus accrued profit or interest on all term deposits", id: "Pokok ditambah keuntungan atau bunga yang terakumulasi pada semua deposito" },
  "zakat.cash.epf": { en: "Include EPF / Provident Fund (Debated)", id: "Sertakan KWSP / Dana Pensiun (Diperdebatkan)" },
  "zakat.cash.epf.help": { en: "Scholarly debate exists on EPF Zakat. Many contemporary scholars require 2.5% on voluntary contributions. Enable based on your followed opinion.", id: "Ada perbedaan pendapat ulama tentang Zakat KWSP. Banyak ulama kontemporer mewajibkan 2,5% atas iuran sukarela. Aktifkan sesuai pendapat yang Anda ikuti." },
  "zakat.cash.epfAmount": { en: "EPF / Provident Fund Balance", id: "Saldo KWSP / Dana Pensiun" },
  "zakat.gold.goldGrams": { en: "Gold Owned (grams)", id: "Emas yang Dimiliki (gram)" },
  "zakat.gold.goldGrams.help": { en: "Total weight of gold coins, bars, and jewellery you own", id: "Total berat koin emas, batangan, dan perhiasan yang Anda miliki" },
  "zakat.gold.goldPrice": { en: "Gold Price per Gram", id: "Harga Emas per Gram" },
  "zakat.gold.goldPrice.help": { en: "Current market gold price per gram in your selected currency", id: "Harga emas pasar saat ini per gram dalam mata uang yang dipilih" },
  "zakat.gold.silverGrams": { en: "Silver Owned (grams)", id: "Perak yang Dimiliki (gram)" },
  "zakat.gold.silverGrams.help": { en: "Total weight of silver coins, bars, and jewellery you own", id: "Total berat koin perak, batangan, dan perhiasan yang Anda miliki" },
  "zakat.gold.silverPrice": { en: "Silver Price per Gram", id: "Harga Perak per Gram" },
  "zakat.gold.silverPrice.help": { en: "Current market silver price per gram. This value is also used to compute the Nisab threshold.", id: "Harga perak pasar saat ini per gram. Nilai ini juga digunakan untuk menghitung batas Nisab." },
  "zakat.gold.jewelry": { en: "Include Personal Jewellery", id: "Sertakan Perhiasan Pribadi" },
  "zakat.gold.jewelry.help": { en: "Hanafi school: zakat applies to all gold and silver including jewellery worn personally. Shafi'i and Hanbali: personal-use jewellery is generally exempt. Toggle based on your madhab.", id: "Mazhab Hanafi: zakat berlaku untuk semua emas dan perak termasuk perhiasan yang dipakai. Syafi'i dan Hanbali: perhiasan untuk dipakai umumnya dikecualikan. Aktifkan sesuai mazhab Anda." },
  "zakat.investments.stocks": { en: "Stocks / Shares (Market Value)", id: "Saham (Nilai Pasar)" },
  "zakat.investments.stocks.help": { en: "Current market value of all equity shareholdings", id: "Nilai pasar saat ini dari semua kepemilikan saham" },
  "zakat.investments.unitTrusts": { en: "Unit Trusts / Mutual Funds", id: "Unit Amanah / Reksa Dana" },
  "zakat.investments.unitTrusts.help": { en: "Net Asset Value (NAV) of all unit trust and mutual fund holdings", id: "Nilai Aset Bersih (NAB) dari semua kepemilikan unit amanah dan reksa dana" },
  "zakat.investments.crypto": { en: "Include Cryptocurrency (Debated)", id: "Sertakan Kripto (Diperdebatkan)" },
  "zakat.investments.crypto.help": { en: "Cryptocurrency is subject to active scholarly debate. Some scholars treat it as a tradeable commodity subject to Zakat; others do not. Enable if you follow scholars who consider it zakatable.", id: "Kripto masih aktif diperdebatkan ulama. Sebagian menganggapnya komoditas dagang yang wajib dizakatkan; sebagian tidak. Aktifkan jika Anda mengikuti ulama yang menganggapnya wajib zakat." },
  "zakat.investments.cryptoAmount": { en: "Crypto Portfolio Value", id: "Nilai Portofolio Kripto" },
  "zakat.business.inventory": { en: "Inventory / Stock-in-Trade", id: "Inventaris / Stok Dagangan" },
  "zakat.business.inventory.help": { en: "Current market value of all goods and products held for sale", id: "Nilai pasar saat ini dari semua barang dan produk yang dijual" },
  "zakat.business.receivables": { en: "Trade Receivables", id: "Piutang Dagang" },
  "zakat.business.receivables.help": { en: "Money owed to you by customers that is expected to be collected", id: "Uang yang terutang kepada Anda oleh pelanggan yang diharapkan dapat ditagih" },
  "zakat.business.liabilities": { en: "Short-term Liabilities (deductible)", id: "Kewajiban Jangka Pendek (dapat dikurangi)" },
  "zakat.business.liabilities.help": { en: "Deduct trade payables, short-term loans, and debts due within the year from your zakatable business assets", id: "Kurangi utang dagang, pinjaman jangka pendek, dan utang yang jatuh tempo dalam setahun dari aset bisnis yang wajib dizakatkan" },
  "zakat.rental.annualIncome": { en: "Annual Rental Income", id: "Pendapatan Sewa Tahunan" },
  "zakat.rental.annualIncome.help": { en: "Total rental income received or receivable during the year", id: "Total pendapatan sewa yang diterima atau terutang selama setahun" },
  "zakat.rental.expenses": { en: "Annual Expenses & Maintenance", id: "Pengeluaran & Pemeliharaan Tahunan" },
  "zakat.rental.expenses.help": { en: "Deduct maintenance costs, repairs, management fees, and financing installments", id: "Kurangi biaya pemeliharaan, perbaikan, biaya pengelolaan, dan cicilan pembiayaan" },
  "zakat.summary.title": { en: "Zakat Summary", id: "Ringkasan Zakat" },
  "zakat.summary.totalZakatable": { en: "Total Zakatable Assets", id: "Total Aset Wajib Zakat" },
  "zakat.summary.nisab": { en: "Nisab Threshold (595g silver)", id: "Batas Nisab (595g perak)" },
  "zakat.summary.zakatDue": { en: "Zakat Due (2.5%)", id: "Zakat Terutang (2,5%)" },
  "zakat.summary.belowNisab": { en: "Below Nisab — No Zakat Due", id: "Di Bawah Nisab — Tidak Wajib Zakat" },
  "zakat.summary.aboveNisab": { en: "Alhamdulillah — Zakat is obligatory", id: "Alhamdulillah — Zakat wajib ditunaikan" },
  "zakat.summary.closeToNisab": { en: "Close to Nisab — double-check your assets", id: "Mendekati Nisab — periksa kembali aset Anda" },
  "zakat.nisab.title": { en: "About Nisab & Hawl", id: "Tentang Nisab & Hawl" },
  "zakat.nisab.text": { en: "Nisab is the minimum wealth threshold above which Zakat becomes obligatory, equal to 595g of silver or 85g of gold (use the lower — silver is traditional). Hawl is the requirement that this wealth has been held for one complete lunar year.", id: "Nisab adalah ambang batas kekayaan minimum yang mewajibkan Zakat, setara dengan 595g perak atau 85g emas (gunakan yang lebih rendah — perak secara tradisi). Hawl adalah syarat bahwa kekayaan ini telah dimiliki selama satu tahun hijriyah penuh." },
  "zakat.reset": { en: "Reset All", id: "Atur Ulang Semua" },
  "zakat.breakdown.cash": { en: "Cash & Savings", id: "Tunai & Tabungan" },
  "zakat.breakdown.gold": { en: "Gold & Silver", id: "Emas & Perak" },
  ...
  "footer.builtBy": { en: "Built by", id: "Dibuat oleh" },
  "footer.privacy": { en: "Privacy", id: "Privasi" },
  "footer.terms": { en: "Terms", id: "Syarat" },

  // ── Brand ──
  "brand.tagline": { en: "Smart calculators for everyday decisions", id: "Kalkulator cerdas untuk keputusan sehari-hari" },

  // ── Nav extras ──
  "nav.salary": { en: "Salary", id: "Gaji" },
  "nav.zakat": { en: "Zakat", id: "Zakat" },

  // ── Tool names (for footer / other non-Home uses) ──
  "tools.normal-calculator.name": { en: "Basic Calculator", id: "Kalkulator Dasar" },
  "tools.scientific-calculator.name": { en: "Scientific Calculator", id: "Kalkulator Ilmiah" },
  "tools.zakat-calculator.name": { en: "Zakat Calculator", id: "Kalkulator Zakat" },
  "tools.wasiat-guide.name": { en: "Wasiat Guide", id: "Panduan Wasiat" },

  // ── Not Found ──
  "notFound.title": { en: "Page not found", id: "Halaman tidak ditemukan" },
  "notFound.message": { en: "The page you're looking for doesn't exist.", id: "Halaman yang Anda cari tidak ada." },

  // ── Privacy Policy ──
  "privacy.title": { en: "Privacy Policy", id: "Kebijakan Privasi" },
  "privacy.lastUpdated": { en: "Last updated: April 28, 2026", id: "Terakhir diperbarui: 28 April 2026" },
  "privacy.p1": { en: "ToolHub MY respects your privacy. Most calculator inputs are processed in your browser and are not sent to our servers.", id: "ToolHub MY menghormati privasi Anda. Sebagian besar input kalkulator diproses di browser Anda dan tidak dikirim ke server kami." },
  "privacy.p2": { en: "We may use analytics and advertising partners (including Google AdSense) that use cookies or similar technologies to measure usage and serve relevant ads.", id: "Kami dapat menggunakan mitra analitik dan iklan (termasuk Google AdSense) yang menggunakan cookie atau teknologi serupa untuk mengukur penggunaan dan menyajikan iklan yang relevan." },
  "privacy.p3": { en: "You can control cookies in your browser settings. By using this site, you consent to data practices described in this policy.", id: "Anda dapat mengontrol cookie di pengaturan browser Anda. Dengan menggunakan situs ini, Anda menyetujui praktik data yang dijelaskan dalam kebijakan ini." },
  "privacy.contact.title": { en: "Contact", id: "Kontak" },
  "privacy.contact.text": { en: "For privacy questions, contact", id: "Untuk pertanyaan privasi, hubungi" },

  // ── Terms of Use ──
  "terms.title": { en: "Terms of Use", id: "Syarat Penggunaan" },
  "terms.lastUpdated": { en: "Last updated: April 28, 2026", id: "Terakhir diperbarui: 28 April 2026" },
  "terms.p1": { en: "ToolHub MY provides calculators and educational guides for informational purposes only. Results may not reflect legal, tax, or religious rulings for your specific case.", id: "ToolHub MY menyediakan kalkulator dan panduan edukasi hanya untuk tujuan informasi. Hasil mungkin tidak mencerminkan keputusan hukum, pajak, atau agama untuk kasus spesifik Anda." },
  "terms.p2": { en: "You are responsible for verifying outcomes and seeking qualified professional advice where required.", id: "Anda bertanggung jawab untuk memverifikasi hasil dan mencari saran profesional yang berkualifikasi jika diperlukan." },
  "terms.p3": { en: "We may update or discontinue tools at any time without notice. Continued use of this website means you accept these terms.", id: "Kami dapat memperbarui atau menghentikan alat kapan saja tanpa pemberitahuan. Penggunaan lanjutan situs ini berarti Anda menerima syarat-syarat ini." },
  "terms.contact.title": { en: "Contact", id: "Kontak" },
  "terms.contact.text": { en: "For terms-related questions, visit", id: "Untuk pertanyaan terkait syarat, kunjungi" },

  // ── Salary Calculator ──
  "salary.badge": { en: "Malaysia payroll estimator", id: "Estimator gaji Malaysia" },
  "salary.title": { en: "Malaysia Salary Calculator", id: "Kalkulator Gaji Malaysia" },
  "salary.subtitle": { en: "Estimate monthly take-home pay after EPF, SOCSO, EIS, and Malaysian income tax. Useful for salary negotiation, offer comparison, and monthly budgeting.", id: "Estimasi gaji bersih bulanan setelah EPF, SOCSO, EIS, dan pajak penghasilan Malaysia. Cocok untuk negosiasi gaji, membandingkan penawaran, dan budgeting bulanan." },
  "salary.takeHomePay": { en: "Estimated monthly take-home pay", id: "Estimasi gaji bersih bulanan" },
  "salary.ofMonthlyGross": { en: "of monthly gross salary", id: "dari gaji kotor bulanan" },
  "salary.fixInputErrors": { en: "Fix input errors to view estimate", id: "Perbaiki input yang error untuk melihat estimasi" },
  "salary.inputs.title": { en: "Inputs", id: "Input" },
  "salary.inputs.subtitle": { en: "Set your employment and tax profile for a closer monthly estimate.", id: "Atur profil pekerjaan dan pajak Anda untuk estimasi bulanan yang lebih akurat." },
  "salary.inputs.monthlySalary": { en: "Monthly gross salary", id: "Gaji kotor bulanan" },
  "salary.inputs.annualBonus": { en: "Annual bonus", id: "Bonus tahunan" },
  "salary.inputs.otherRelief": { en: "Other annual relief", id: "Pelepasan tahunan lainnya" },
  "salary.inputs.otherRelief.hint": { en: "Lifestyle, spouse, child, insurance, and other claimable relief.", id: "Pelepasan gaya hidup, pasangan, anak, asuransi, dan lain-lain." },
  "salary.inputs.epfRate": { en: "EPF employee rate (%)", id: "Kadar caruman EPF pekerja (%)" },
  "salary.inputs.epfRate.hint.foreign": { en: "For foreign worker / expat, minimum EPF rate is 2%. You can set above 2%.", id: "Untuk pekerja asing / ekspatriat, kadar EPF minimum adalah 2%. Anda boleh menetapkan di atas 2%." },
  "salary.inputs.epfRate.hint.local": { en: "Typical default is 11% for Malaysian/PR employees.", id: "Kadar lalai biasa adalah 11% untuk pekerja Malaysia/PR." },
  "salary.inputs.workerType": { en: "Worker type", id: "Jenis pekerja" },
  "salary.inputs.workerType.malaysian": { en: "Malaysian / PR", id: "Warga Malaysia / PR" },
  "salary.inputs.workerType.foreigner": { en: "Foreign worker / expat", id: "Pekerja asing / ekspatriat" },
  "salary.inputs.taxResidency": { en: "Tax residency", id: "Status cukai" },
  "salary.inputs.resident": { en: "Resident", id: "Pemastautin" },
  "salary.inputs.nonResident": { en: "Non-resident", id: "Bukan pemastautin" },
  "salary.disclaimer": { en: "Estimate only. This is not official PCB/payroll/tax advice. SOCSO and EIS in real payroll should follow official contribution tables issued by authorities.", id: "Angka anggaran sahaja. Ini bukan nasihat PCB/penggajian/cukai rasmi. SOCSO dan EIS dalam penggajian sebenar perlu mengikut jadual caruman rasmi yang dikeluarkan oleh pihak berkuasa." },
  "salary.negativeWarning": { en: "Estimated deductions are higher than monthly gross salary. Review EPF rate, reliefs, and residency settings.", id: "Anggaran potongan lebih tinggi daripada gaji kotor bulanan. Semak kadar EPF, pelepasan, dan tetapan pemastautin." },
  "salary.epfMonth": { en: "EPF / month", id: "KWSP / bulan" },
  "salary.taxMonth": { en: "Estimated tax / month", id: "Anggaran cukai / bulan" },
  "salary.socsoMonth": { en: "SOCSO / month", id: "PERKESO / bulan" },
  "salary.eisMonth": { en: "EIS / month", id: "SIP / bulan" },
  "salary.rateEstimate": { en: "Rate estimate:", id: "Anggaran kadar:" },
  "salary.annual.title": { en: "Annual summary", id: "Ringkasan tahunan" },
  "salary.annual.subtitle": { en: "High-level estimate for planning and comparison.", id: "Anggaran umum untuk perancangan dan perbandingan." },
  "salary.save": { en: "Save", id: "Simpan" },
  "salary.monthlyTakeHome": { en: "Monthly take-home pay", id: "Gaji bersih bulanan" },
  "salary.ofGross": { en: "of gross", id: "daripada gaji kotor" },
  "salary.annualGross": { en: "Annual gross", id: "Gaji kotor tahunan" },
  "salary.beforeDeductions": { en: "Before deductions", id: "Sebelum potongan" },
  "salary.chargeableIncome": { en: "Chargeable income estimate", id: "Anggaran pendapatan bercukai" },
  "salary.afterReliefs": { en: "After reliefs and deductible items", id: "Selepas pelepasan dan potongan" },
  "salary.annualTax": { en: "Annual tax estimate", id: "Anggaran cukai tahunan" },
  "salary.effectiveTax": { en: "Effective tax:", id: "Cukai efektif:" },
  "salary.estimatedMonthlyTax": { en: "Estimated monthly tax", id: "Anggaran cukai bulanan" },
  "salary.approxMonthlyRate": { en: "Approx monthly rate:", id: "Kadar bulanan anggaran:" },
  "salary.monthlyDeductions": { en: "Monthly deductions", id: "Potongan bulanan" },
  "salary.deductionItems": { en: "EPF + SOCSO + EIS + tax", id: "KWSP + PERKESO + SIP + cukai" },
  "salary.validation.monthlySalary": { en: "Monthly gross salary must be greater than 0.", id: "Gaji kotor bulanan mesti lebih daripada 0." },
  "salary.validation.annualBonus": { en: "Annual bonus cannot be negative.", id: "Bonus tahunan tidak boleh negatif." },
  "salary.validation.otherRelief": { en: "Other annual relief cannot be negative.", id: "Pelepasan tahunan lainnya tidak boleh negatif." },
  "salary.validation.epfForeigner": { en: "EPF employee rate for foreign worker / expat must be between 2% and 15%.", id: "Kadar EPF pekerja asing / ekspatriat mesti antara 2% dan 15%." },
  "salary.validation.epfLocal": { en: "EPF employee rate must be between 0% and 15%.", id: "Kadar EPF pekerja mesti antara 0% dan 15%." },
  ...
  "a11y.calc.xSquared": { en: "x squared", id: "x kuadrat" },
  "a11y.calc.xPowerY": { en: "x to the power y", id: "x pangkat y" },
  "a11y.calc.oneOverX": { en: "one over x", id: "satu per x" },
  "a11y.calc.factorial": { en: "factorial", id: "faktorial" },
  "a11y.calc.absoluteValue": { en: "absolute value", id: "nilai mutlak" },
  "a11y.calc.squareRoot": { en: "square root", id: "akar kuadrat" },
  "a11y.calc.pi": { en: "pi", id: "pi" },
  "a11y.calc.euler": { en: "Euler's number", id: "Bilangan Euler" },
  "a11y.calc.openParen": { en: "open parenthesis", id: "kurung buka" },
  "a11y.calc.closeParen": { en: "close parenthesis", id: "kurung tutup" },
  "a11y.calc.arcsine": { en: "arcsine", id: "arcsine" },
  "a11y.calc.arccosine": { en: "arccosine", id: "arccosine" },
  "a11y.calc.arctangent": { en: "arctangent", id: "arctangent" },
