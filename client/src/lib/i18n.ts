...
const translations = {
  ...
  "epf.inputs.workerType": { en: "Citizenship", ms: "Kewarganegaraan", id: "Kewarganegaraan" },
  "epf.workerType.citizen": { en: "Malaysian citizen / PR", ms: "Warganegara Malaysia / PR", id: "Warga negara Malaysia / PR" },
  "epf.workerType.foreigner": { en: "Non-citizen", ms: "Bukan warganegara", id: "Non-warga negara" },
  "epf.workerType.hint": {
    en: "EPF became mandatory for non-citizens under 75 on 1 October 2025, at 2% from each side.",
    ms: "KWSP menjadi wajib bagi bukan warganegara bawah 75 pada 1 Oktober 2025, 2% setiap pihak.",
    id: "EPF menjadi wajib bagi non-warga negara di bawah 75 pada 1 Oktober 2025, 2% dari tiap pihak.",
  },
  "epf.accounts.title": { en: "Where your savings sit", ms: "Di mana simpanan anda", id: "Di mana tabungan Anda" },
  "epf.accounts.subtitle": {
    en: "Contributions have been split three ways since 11 May 2024.",
    ms: "Caruman dibahagi tiga sejak 11 Mei 2024.",
    id: "Iuran dibagi tiga sejak 11 Mei 2024.",
  },
  "epf.accounts.persaraan": { en: "Akaun Persaraan", ms: "Akaun Persaraan", id: "Akaun Persaraan" },
  "epf.accounts.persaraan.hint": { en: "75% of contributions. Locked until 55.", ms: "75% caruman. Terkunci sehingga 55.", id: "75% iuran. Terkunci hingga 55." },
  "epf.accounts.sejahtera": { en: "Akaun Sejahtera", ms: "Akaun Sejahtera", id: "Akaun Sejahtera" },
  "epf.accounts.sejahtera.hint": { en: "15%. For housing, education and health.", ms: "15%. Untuk perumahan, pendidikan dan kesihatan.", id: "15%. Untuk perumahan, pendidikan dan kesehatan." },
  "epf.accounts.fleksibel": { en: "Akaun Fleksibel", ms: "Akaun Fleksibel", id: "Akaun Fleksibel" },
  "epf.accounts.fleksibel.hint": { en: "10%. Withdrawable at any time.", ms: "10%. Boleh dikeluarkan bila-bila masa.", id: "10%. Dapat ditarik kapan saja." },
  "epf.accounts.openingNote": {
    en: "Your current balance is counted as Akaun Persaraan, since the split applies to new contributions only.",
    ms: "Baki semasa anda dikira sebagai Akaun Persaraan, kerana pembahagian hanya terpakai pada caruman baharu.",
    id: "Saldo Anda saat ini dihitung sebagai Akaun Persaraan, karena pembagian hanya berlaku pada iuran baru.",
  },
  "epf.accounts.consolidated": {
    en: "Your projection runs past 55, where the three accounts merge into Akaun 55, so no split is shown.",
    ms: "Unjuran anda melepasi 55, di mana ketiga-tiga akaun bergabung menjadi Akaun 55, jadi tiada pembahagian ditunjukkan.",
    id: "Proyeksi Anda melewati 55, saat ketiga akun digabung menjadi Akaun 55, jadi tidak ada pembagian ditampilkan.",
  },
  "epf.tiers.title": { en: "Retirement Income Adequacy", ms: "Kecukupan Pendapatan Persaraan", id: "Kecukupan Pendapatan Pensiun" },
  "epf.tiers.subtitle": { en: "KWSP's three savings tiers, effective 1 January 2026.", ms: "Tiga tahap simpanan KWSP, berkuat kuasa 1 Januari 2026.", id: "Tiga tingkat tabungan KWSP, berlaku 1 Januari 2026." },
  "epf.tiers.basic": { en: "Basic", ms: "Asas", id: "Dasar" },
  "epf.tiers.adequate": { en: "Adequate", ms: "Mencukupi", id: "Memadai" },
  "epf.tiers.enhanced": { en: "Enhanced", ms: "Ditingkatkan", id: "Ditingkatkan" },
  "epf.tiers.reached": { en: "Reached", ms: "Dicapai", id: "Tercapai" },
  "epf.tiers.none": { en: "Your projection does not yet reach the Basic tier.", ms: "Unjuran anda belum mencapai tahap Asas.", id: "Proyeksi Anda belum mencapai tingkat Dasar." },
  "epf.results.targetEstimate": {
    en: "Estimated. The Basic Savings target is being raised in stages to RM390,000 by 2028, and only the age-60 figures are published for each stage.",
    ms: "Anggaran. Sasaran Simpanan Asas dinaikkan berperingkat kepada RM390,000 menjelang 2028, dan hanya angka umur 60 diterbitkan bagi setiap peringkat.",
    id: "Perkiraan. Target Tabungan Dasar dinaikkan bertahap ke RM390.000 pada 2028, dan hanya angka usia 60 yang dipublikasikan tiap tahap.",
  },
  ...
  "housing.inputs.margin": { en: "Margin of finance", ms: "Margin pembiayaan", id: "Margin pembiayaan" },
  "housing.inputs.margin.hint": {
    en: "How much of the price the bank lends. Usually up to 90% for your first two homes; the rest is your down payment.",
    ms: "Berapa banyak harga yang dibiayai bank. Biasanya sehingga 90% bagi dua rumah pertama; bakinya bayaran pendahuluan anda.",
    id: "Berapa banyak harga yang dibiayai bank. Biasanya hingga 90% untuk dua rumah pertama; sisanya uang muka Anda.",
  },
  "housing.inputs.margin.hintForeign": {
    en: "How much of the price the bank lends. Non-citizens are typically capped lower, around 70-80%.",
    ms: "Berapa banyak harga yang dibiayai bank. Bukan warganegara biasanya dihadkan lebih rendah, sekitar 70-80%.",
    id: "Berapa banyak harga yang dibiayai bank. Non-warga negara biasanya dibatasi lebih rendah, sekitar 70-80%.",
  },
  "housing.inputs.motShare": { en: "Developer covers this much of the MOT", ms: "Pemaju menanggung sebanyak ini daripada MOT", id: "Pengembang menanggung sebanyak ini dari MOT" },
  "housing.inputs.motShare.hint": {
    en: "0 means you pay the full duty, 100 is a free-MOT package. Half of a non-citizen's 8% duty leaves you paying an effective 4%.",
    ms: "0 bermaksud anda bayar duti penuh, 100 ialah pakej MOT percuma. Separuh daripada duti 8% bukan warganegara meninggalkan kadar berkesan 4%.",
    id: "0 berarti Anda membayar bea penuh, 100 adalah paket MOT gratis. Setengah dari bea 8% non-warga negara menyisakan tarif efektif 4%.",
  },
  "housing.marginOfFinance": { en: "Margin of finance", ms: "Margin pembiayaan", id: "Margin pembiayaan" },
  "housing.motAbsorbed": { en: "Covered by developer", ms: "Ditanggung pemaju", id: "Ditanggung pengembang" },
  "housing.of": { en: "of", ms: "daripada", id: "dari" },
  ...
  "housing.breakdown.title": { en: "Cost breakdown", ms: "Pecahan kos", id: "Rincian biaya" },
  "housing.breakdown.subtitle": { en: "The loan, and the cash you need before keys are handed over.", ms: "Pinjaman, dan tunai yang diperlukan sebelum kunci diserahkan.", id: "Pinjaman, dan uang tunai yang dibutuhkan sebelum serah terima kunci." },
  "housing.group.loan": { en: "Your loan", ms: "Pinjaman anda", id: "Pinjaman Anda" },
  "housing.group.cash": { en: "Cash needed upfront", ms: "Tunai diperlukan di awal", id: "Uang tunai dibutuhkan di muka" },
  "housing.propertyPrice": { en: "Property price", ms: "Harga hartanah", id: "Harga properti" },
  "housing.totalRepayment": { en: "Total repayment", ms: "Jumlah bayaran balik", id: "Total pembayaran" },
  "housing.totalRepayment.hint": { en: "Loan amount plus all interest over the full term.", ms: "Jumlah pinjaman campur semua faedah sepanjang tempoh.", id: "Jumlah pinjaman ditambah seluruh bunga sepanjang tenor." },
  "housing.atRate": { en: "at", ms: "pada", id: "pada" },
  ...
  "bmi.disclaimer": {
    en: "Estimates only, and not a medical diagnosis. Categories follow the Malaysian CPG for the Management of Obesity (2023). BMI does not distinguish muscle from fat. Speak to a doctor about your own health.",
    ms: "Anggaran sahaja, bukan diagnosis perubatan. Kategori mengikut CPG Malaysia bagi Pengurusan Obesiti (2023). BMI tidak membezakan otot daripada lemak. Berbincang dengan doktor tentang kesihatan anda.",
    id: "Hanya perkiraan, bukan diagnosis medis. Kategori mengikuti CPG Malaysia untuk Penanganan Obesitas (2023). BMI tidak membedakan otot dari lemak. Bicarakan kesehatan Anda dengan dokter.",
  },
  ...
  "bmi.category.preObese": { en: "Pre-obese (overweight)", ms: "Pra-obes (berlebihan berat)", id: "Pra-obesitas (kelebihan berat)" },
  "bmi.cutoffs.note": {
    en: "Classified using Malaysia's Ministry of Health cut-offs: pre-obesity at 23 and obesity above 27.5. These are lower than the international 25 and 30, because Asians carry more body fat and face higher risk at the same BMI.",
    ms: "Dikelaskan menggunakan nilai potong Kementerian Kesihatan Malaysia: pra-obesiti pada 23 dan obesiti melebihi 27.5. Ia lebih rendah daripada 25 dan 30 antarabangsa, kerana orang Asia mempunyai lebih lemak badan dan risiko lebih tinggi pada BMI yang sama.",
    id: "Diklasifikasikan memakai ambang Kementerian Kesehatan Malaysia: pra-obesitas pada 23 dan obesitas di atas 27,5. Ini lebih rendah dari 25 dan 30 internasional, karena orang Asia memiliki lebih banyak lemak tubuh dan risiko lebih tinggi pada BMI yang sama.",
  },
  "bmi.international.differs": {
    en: "An international BMI chart would call this",
    ms: "Carta BMI antarabangsa akan menyebutnya",
    id: "Bagan BMI internasional akan menyebutnya",
  },
  "bmi.international.hint": {
    en: "Most calculators use the international chart. Malaysia's guideline is the one that applies to you.",
    ms: "Kebanyakan kalkulator menggunakan carta antarabangsa. Garis panduan Malaysia yang terpakai kepada anda.",
    id: "Kebanyakan kalkulator memakai bagan internasional. Pedoman Malaysia yang berlaku untuk Anda.",
  },
  "bmi.child.title": { en: "Adult BMI categories do not apply under 18", ms: "Kategori BMI dewasa tidak terpakai bawah 18", id: "Kategori BMI dewasa tidak berlaku di bawah 18" },
  "bmi.child.body": {
    en: "A growing child's healthy BMI changes with age and sex, so a single set of thresholds cannot classify them. Malaysia's clinical guideline directs that the WHO BMI-for-age chart be used instead. The BMI figure below is still correct — only the category is withheld. Please check it against the WHO BMI-for-age chart, or ask a doctor.",
    ms: "BMI sihat bagi kanak-kanak yang membesar berubah mengikut umur dan jantina, jadi satu set nilai potong tidak boleh mengelaskannya. Garis panduan klinikal Malaysia menetapkan carta BMI-mengikut-umur WHO digunakan. Angka BMI di bawah tetap betul — hanya kategori ditahan. Sila semak dengan carta BMI-mengikut-umur WHO, atau tanya doktor.",
    id: "BMI sehat anak yang sedang tumbuh berubah menurut usia dan jenis kelamin, jadi satu set ambang tidak dapat mengklasifikasikannya. Pedoman klinis Malaysia menetapkan bagan BMI-menurut-usia WHO digunakan. Angka BMI di bawah tetap benar — hanya kategorinya yang ditahan. Silakan periksa dengan bagan BMI-menurut-usia WHO, atau tanya dokter.",
  },
  "bmi.child.categoryUnavailable": { en: "Not classified", ms: "Tidak dikelaskan", id: "Tidak diklasifikasikan" },
  ...
  "fd.compounded.hint": { en: "Value after every renewal, with interest rolled into each new placement.", ms: "Nilai selepas setiap pembaharuan, dengan faedah digulung ke dalam setiap simpanan baharu.", id: "Nilai setelah tiap perpanjangan, dengan bunga digulung ke tiap penempatan baru." },
  ...
  "fd.inputs.cycles": { en: "Number of placements", ms: "Bilangan penempatan", id: "Jumlah penempatan" },
  "fd.inputs.cycles.hint": {
    en: "1 means a single placement. Interest only compounds when you renew, once per tenure — never within one.",
    ms: "1 bermaksud satu penempatan. Faedah hanya berkompaun apabila anda membaharui, sekali setiap tempoh — bukan di dalamnya.",
    id: "1 berarti satu penempatan. Bunga hanya berbunga saat Anda perpanjang, sekali per tenor — bukan di dalamnya.",
  },
  "fd.totalPeriod": { en: "Total period", ms: "Tempoh keseluruhan", id: "Total periode" },
  "fd.effectiveRate": { en: "Effective annual return", ms: "Pulangan tahunan berkesan", id: "Imbal hasil tahunan efektif" },
  "fd.effectiveRate.hint": {
    en: "Annualised over the whole period, so tenures of different lengths compare fairly.",
    ms: "Ditahunkan sepanjang tempoh, supaya tempoh berbeza panjang dapat dibandingkan secara adil.",
    id: "Disetahunkan sepanjang periode, agar tenor yang berbeda panjang dapat dibandingkan secara adil.",
  },
  "fd.noCompounding": {
    en: "A single placement earns no compounding bonus — an FD pays simple interest at maturity, and nothing compounds inside a tenure.",
    ms: "Satu penempatan tidak memperoleh bonus kompaun — FD membayar faedah mudah pada tarikh matang, dan tiada apa berkompaun dalam satu tempoh.",
    id: "Satu penempatan tidak memperoleh bonus majemuk — deposito membayar bunga sederhana saat jatuh tempo, dan tidak ada yang berbunga di dalam satu tenor.",
  },
  "fd.pidm.title": { en: "PIDM protection", ms: "Perlindungan PIDM", id: "Perlindungan PIDM" },
  "fd.pidm.covered": { en: "Fully protected", ms: "Dilindungi sepenuhnya", id: "Terlindungi penuh" },
  "fd.pidm.exceeded": { en: "Above the protection limit by", ms: "Melebihi had perlindungan sebanyak", id: "Melebihi batas perlindungan sebesar" },
  "fd.pidm.hint": {
    en: "PIDM protects RM250,000 per depositor per member bank, counting principal and interest together. Conventional and Islamic deposits are protected separately.",
    ms: "PIDM melindungi RM250,000 setiap pendeposit setiap bank ahli, mengira pokok dan faedah bersama. Deposit konvensional dan Islam dilindungi secara berasingan.",
    id: "PIDM melindungi RM250.000 per deposan per bank anggota, menghitung pokok dan bunga bersama. Deposito konvensional dan syariah dilindungi terpisah.",
  },
  "fd.withdraw.title": { en: "Breaking the deposit early", ms: "Memecahkan simpanan lebih awal", id: "Mencairkan deposito lebih awal" },
  "fd.withdraw.enable": { en: "Model an early withdrawal", ms: "Model pengeluaran awal", id: "Modelkan penarikan awal" },
  "fd.withdraw.after": { en: "Withdraw after (months)", ms: "Keluarkan selepas (bulan)", id: "Tarik setelah (bulan)" },
  "fd.withdraw.after.hint": { en: "Only whole completed months count.", ms: "Hanya bulan penuh yang dikira.", id: "Hanya bulan penuh yang dihitung." },
  "fd.withdraw.ratePaid": { en: "Rate actually paid", ms: "Kadar sebenar dibayar", id: "Tarif yang benar-benar dibayar" },
  "fd.withdraw.interestPaid": { en: "Interest received", ms: "Faedah diterima", id: "Bunga diterima" },
  "fd.withdraw.forfeited": { en: "Interest given up", ms: "Faedah dilepaskan", id: "Bunga yang hilang" },
  "fd.withdraw.received": { en: "You would receive", ms: "Anda akan menerima", id: "Anda akan menerima" },
  "fd.withdraw.noInterest": {
    en: "Withdrawing before three completed months forfeits the interest entirely — you get back only your principal.",
    ms: "Pengeluaran sebelum tiga bulan penuh melucutkan semua faedah — anda hanya mendapat pokok kembali.",
    id: "Penarikan sebelum tiga bulan penuh menghanguskan seluruh bunga — Anda hanya menerima pokok kembali.",
  },
  "fd.withdraw.hint": {
    en: "Common bank practice: nothing before three completed months, then about half the contracted rate. Terms vary by bank, so check your contract.",
