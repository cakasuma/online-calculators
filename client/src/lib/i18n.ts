...
const translations = {
  ...
  "housing.disclaimer": {
    en: "Estimates only. Stamp duty and legal fee scales follow 2024 published rates; banks may quote different interest and insurance costs. Confirm with your lawyer and bank.",
    ms: "Anggaran sahaja. Skala duti setem dan yuran guaman mengikut kadar 2024 yang diterbitkan; bank mungkin menyebut kos faedah dan insurans berbeza. Sahkan dengan peguam dan bank anda.",
    id: "Hanya perkiraan. Skala bea meterai dan biaya hukum mengikuti tarif 2024; bank mungkin mengutip bunga dan biaya asuransi berbeda. Konfirmasikan dengan pengacara dan bank Anda.",
  },
